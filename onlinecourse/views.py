...
def show_exam_result(request, course_id, submission_id):
    ...
    question_results = []
    for question in course.question_set.all():
        is_correct = question.choice_set.filter(id__in=selected_choice_ids, is_correct=True).exists()
    ...
    total_score = sum(question.grade_point for question in course.question_set.all())
